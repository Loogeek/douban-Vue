...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChooseMovies = __webpack_require__(4);

	var _ChooseMovies2 = _interopRequireDefault(_ChooseMovies);
	...
	new _vue2.default({
	  el: '#fliterMovies',
	  components: {
	    ChooseMovies: _ChooseMovies2.default
	  }
	});
	  ...
	  var movieIndexFun = function () {
	    ...
	    */
	    var gallerySwitch = function () {
	      var $oPanel = $('#scrollMoives .panel'),
	          // 获取顶部轮播图面板对象
	      $oTitle = $('#headerNow span'),
	          // 获取即将上映标题对象
	      page = 1,
	          // 初始页码
	      $oLeft = $('#scrollMoives .slide-prev'),
	          // 获取左箭头按钮
	      $oRight = $('#scrollMoives .slide-next'),
	          // 获取右箭头按钮
	      $oThumbnail = $('#scrollMoives .thumbnail'),
	          // 获取电影对象
	    ...
	    var galleryFrames = function () {
	      ...
	      $oRight = $('#galleryFrames .slide-next'),
	          // 向右箭头
	      len = $('#galleryFrames li').length,
	          // 热门推荐轮播图片数量
	      $oUl = $('#galleryFrames ul'),
	          // 获取轮播图列表的对象
	    ...
	    */
	    var cinemasSearch = function () {
	      ...
	      $citySug = $('#citySug'),
	          // 电影院对象
	      $citySugList = $('#citySug .city-suggestion-list'),
	          // 电影院名称列表对象
	      $cityTip = $('#citySug .auto-tip'),
	          // 可售票影院列表ul对象
	      ...
	      $('.cities-list-hd').on('click', 'li', function () {
	        ...
	        $cList.find('.cities-list-item').eq(index - 1).addClass('active').siblings().removeClass('active'); // 添加active样式，让其点击范围的城市显示
	      });
	      ...
	      var funGetCityCinemas = function funGetCityCinemas() {
	    ...
	    //Ajax请求函数
	    var funAjax = function funAjax(URL, method, cb) {
	      $.ajax({
	        url: URL,
	        cache: true,
	        type: method,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] public/scripts/components/movie/ChooseMovies.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/xiaolong/Desktop/douban/douban-Vue/public/scripts/components/movie/ChooseMovies.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TitleTop = __webpack_require__(44);

	var _TitleTop2 = _interopRequireDefault(_TitleTop);

	var _ChooseMovieItem = __webpack_require__(47);

	var _ChooseMovieItem2 = _interopRequireDefault(_ChooseMovieItem);
	...
	exports.default = {
		...
		components: {
			...
			ChooseMovieItem: _ChooseMovieItem2.default
		},
		data: function data() {
			return {
				title: ['热门', '最新', '经典', '豆瓣高分', '冷门佳片', '华语', '欧美', '韩国'],
				selected: '热门',
				dataList: [],
				currentData: {} };
		},
		...
		methods: {
			getData: function getData(value) {
				...
				var url = '/?fliterName=' + encodeURIComponent(value + '电影');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] public/scripts/components/movie/TitleTop.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/xiaolong/Desktop/douban/douban-Vue/public/scripts/components/movie/TitleTop.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "<li v-for=\"titleItem of title\"><button @click=\"handleTitleChange(titleItem)\" :class=\"titleItem === selected ? 'btn btn-primary' : 'btn btn-default'\">{{ titleItem }}</button></li>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] public/scripts/components/movie/ChooseMovieItem.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/xiaolong/Desktop/douban/douban-Vue/public/scripts/components/movie/ChooseMovieItem.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "<div v-for=\"item of data.movies\" class=\"col-md-3 col-xs-4\"><div class=\"thumbnail\"><a href=\"/movie/{{ item._id }}\" target=\"_blank\"><img :src=\"item.poster\" :alt=\"item.title\"/></a><div class=\"caption\"><h5>{{ item.title }}</h5></div></div></div>";

/***/ },
/* 50 */
/***/ function(module, exports) {

	module.exports = "<div class=\"screen\"><div class=\"class-top\"><span class=\"active\">选电影</span><i>&nbsp;/&nbsp;</i><span>选电视剧</span><hr/><ul><title-top :title=\"title\" :selected.sync=\"selected\"></title-top></ul><hr/><div class=\"screen-body\"><div class=\"panel panel-default\"><div id=\"classBody\" class=\"panel-body screen-body\"><choose-movie-item :data=\"currentData\"></choose-movie-item></div><a href=\"javascript:;\" role=\"button\" class=\"more\">加载更多        </a></div></div></div></div>";
